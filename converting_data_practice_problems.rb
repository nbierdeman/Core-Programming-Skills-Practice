...
# hash.each_pair do |key, value|
#   array << { id: key, name: value[:name], age: value[:age] }
# end
...
# old_hash = { "chair" => 75, "book" => 15 }
# old_array = [{ name: "chair", color: "red", weight: 10 }, { name: "book", color: "black", weight: 1 }]
# new_hash = {}
# index = 0
# old_hash.each_key do |key|
#   old_array[index].delete(:name)
#   new_hash[key] = old_array[index]
#   index += 1
# end
# new_hash["chair"][:price] = old_hash["chair"]
# new_hash["book"][:price] = old_hash["book"]
# p new_hash
...
#   hash[array[index][:author]] = []
#   index += 1
# end
# index = 0
# while index < array.length
#   hash.each_key do |key|
#     if key == array[index][:author]
#       hash[key].push(array[index][:title])
#     end
#   end
#   index += 1
# end
